          ...
          <aside className="settings-drawer" role="dialog" aria-modal="true" aria-labelledby="settings-title">
            ...
            <form onSubmit={applySettings}>
              ...
              {draftConfiguration.mode === "live" ? (
                <label className="field"><span>WebSocket URL</span><input type="url" value={draftConfiguration.url} onChange={(event) => setDraftConfiguration((current) => ({ ...current, url: event.target.value }))} placeholder="wss://api.example.com/session-chat" autoFocus /></label>
              ) : (
